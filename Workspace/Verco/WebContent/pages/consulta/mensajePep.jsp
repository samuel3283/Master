...
function consultar() {
   	document.forms['idConsultaForm'].method.value = 'buscarMensajePep';
    document.forms['idConsultaForm'].submit();
}
function limpiar(){
   	document.forms['idConsultaForm'].method.value = 'initMensajePep';
    document.forms['idConsultaForm'].submit();
}
     ...
     <tr>
        <td> 
           <table width="680" border="0" cellpadding="0" cellspacing="3"
				...
				<tr>
					<td colspan="6" >
					<font color="#336699">Consulta Mensajes PEP que generaron EABDCP</font>
					</td>
				</tr>
