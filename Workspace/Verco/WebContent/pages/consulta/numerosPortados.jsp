...
function consultar() {
   	document.forms['idConsultaForm'].method.value = 'buscarNumerosPortados';
    document.forms['idConsultaForm'].submit();
}
function limpiar(){
   	document.forms['idConsultaForm'].method.value = 'initNumerosPortados';
    document.forms['idConsultaForm'].submit();
}
...
>
    ...
    <table border="0" width="100%" >
     <tr>
        <td> 
           <table width="680" border="0" cellpadding="0" cellspacing="3"
				...
				<tr>
					<td colspan="6" >
					<font color="#336699">Consultar Números Portados por Fecha</font>
					</td>
				</tr>
				...
				<tr>
					...
					<td width="9">&nbsp;
					<html:select property="consulta1VO.receptor" styleId="consulta1VO.receptor">												
					<html:option value="20">20-Nextel</html:option>													
					<html:option value="21">21-Claro</html:option>													
					<html:option value="22">22-Telefonica</html:option>												
					</html:select>
     ...
     <!--<th align="center">Cedente Inicial</th>-->
     <th align="center">Id Proceso</th>
     <th align="center">Nro Secuencial</th>
     <th align="center">Inicio Proceso</th>
     <th align="center">Inicio Ventana</th>
     <th align="center">Tipo Portabilidad</th>
	</tr>
	<% int contador=0;%>
