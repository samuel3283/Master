...
function consultar() {
   	document.forms['idConsultaForm'].method.value = 'buscarMensajeOcc';
    document.forms['idConsultaForm'].submit();
}
function limpiar(){
   	document.forms['idConsultaForm'].method.value = 'initMensajeOcc';
    document.forms['idConsultaForm'].submit();
}
...
function generarExcel() {
    window.open('<%=request.getContextPath()%>/consultaAction.do?method=mensajeOccXls','window','height=300,width=500,status=yes,toolbar=yes,resizable=yes,scrollbars=yes');
}
     ...
     <tr>
        <td> 
           <table width="680" border="0" cellpadding="0" cellspacing="3"
				...
				<tr>
					<td colspan="6" >
					<font color="#336699">Consulta Mensajes OCC por Fecha</font>
					</td>
				</tr>
