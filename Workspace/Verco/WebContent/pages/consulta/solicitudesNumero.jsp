...
function consultar() {
   	document.forms['idConsultaForm'].method.value = 'buscarSolicitudesNumero';
    document.forms['idConsultaForm'].submit();
}
function limpiar(){
   	document.forms['idConsultaForm'].method.value = 'initConsultaSolicitudesNumero';
    document.forms['idConsultaForm'].submit();
}
...
>
 ...
 <table width="680" border="0" cellpadding="0" cellspacing="3" class="gNarrowContentSection">
				...
				<tr>
					<td colspan="6" >
					<font color="">
					<input type="radio" name="busqueda" checked onclick="document.getElementById('tipBus').value='S';" ></>Por Número:
					</font>
					</td>
				</tr>
				<tr>				
					...
					<td>
					<html:text
						styleId="secuencial" property="consulta1VO.telefono"
						size="17" maxlength="9" styleClass="formInputBoxText"
				...
				<tr>
					<td colspan="6" >
					<font color="">
					<input type="radio" name="busqueda" onclick="document.getElementById('tipBus').value='P';"></>Por Trk:
					</font>
					</td>
				</tr>
				...
				<b>Track Id:</b>
					...
					<html:text
						...
						size="17" maxlength="8" styleClass="formInputBoxText"
						/> 	
				</td>
				</tr>
	...
	<% int contador=0;%>
     ...
     id="lista" type="pe.com.nextel.provisioning.model.vo.SolicitudVO">
      <% contador++;%>
     <tr>
	 ...
	 <%
	     params.put("idInterno", lista.getIdInterno());            
 	     params.put("tipoMensaje", lista.getTipoMensaje());            
	 %>
	 <html:link page="/ConsultaAction.do?metodo=buscarSolicitudesNumero" name="params" scope="page"> 
