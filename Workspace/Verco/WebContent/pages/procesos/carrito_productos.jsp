...
<html:html>
 <body>
    ...
    <table border="0" width="100%" >
        ...
        <td> 
           <table width="680" border="0" cellpadding="0" cellspacing="3"
				...
				<tr>
					...
					<font color="#336699" size="3"><br>PRODUCTOS</font>
					</td>
				</tr>
				<tr>
     ...
     <td>
      <table width="680" border="0" cellpadding="0" cellspacing="3"	class="gNarrowContentSection">
		...
		<th bgcolor="#336699"><font color="#FFFFFF">Imagen</font></th>
	...
	<logic:iterate name="consultaForm" property="listaMensajes" id="lista" type="pe.com.nextel.provisioning.model.vo.Producto">
     ...
     <img src="<%=request.getContextPath()%>/pages/images/articulos/<bean:write name='lista' property='ruta'/>" border="0" 
     width="80" height="100">
	...
	&nbsp;&nbsp; 
     <a href="<%=request.getContextPath()%>/consultaAction.do?method=dispro" title="Agregar al carrito" target=":BLANK">
...
function consultar() {
   	document.forms['idConsultaForm'].method.value = 'buscacarrito';
    document.forms['idConsultaForm'].submit();
}
function limpiar(){
