 ...
 * @author Snavarro
 */
public class JdbcBpmPorta implements Parametros {

	private static Connection cn = null;
    private static JdbcBpmPorta singleton = null;
    private static Logger logger = Logger.getLogger(JdbcBpmPorta.class.getName()); 
    private static String environmentContext= "java:comp/env/";
    
    public static JdbcBpmPorta getInstance()  
    {/*
        if (singleton == null)
        { 
            singleton = new JdbcUtilitario();
        }*/
      singleton = new JdbcBpmPorta();
        return singleton;   
    }
    ...
    throws Exception
{
    ...
    public Connection getConnectionJDBC() throws Exception
    {
      try {
            ...
            cn =  DriverManager.getConnection(url, USUARIO_BPM, PASSWORD_BPM);
